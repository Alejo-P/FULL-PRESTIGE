...
export const registerPayments = async (req, res) => {
    ...
    try {
        ...
        return res.status(400).json({ message: 'Error al registrar el pago', error: error.message });
    }
};
...
export const getPayments = async (req, res) => {
    ...
    try {
        ...
        return res.status(500).json({ mesage: "Error al obtener los pagos", error: error.message });
    }
};
...
export const updatePayment = async (req, res) => {
    ...
    try {
        ...
        return res.status(500).json({message: "Error al actualizar un pago", error: error.message });
    }
};